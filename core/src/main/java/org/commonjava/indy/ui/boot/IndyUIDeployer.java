...
import static org.commonjava.indy.ui.util.ApplicationContent.application_gzip;

@ApplicationScoped
public class IndyUIDeployer
        implements Deployer
{
    ...
    public IndyUIDeployer()
    {
    }

    @Inject
    private IndyUIDeployment indyDeployment;
    ...
    static
    {
        NO_NEED_GZIPPED_CONTENT.add( application_gzip );
