 ...
 */
package org.commonjava.indy.ui.client;
...
import org.commonjava.indy.ui.keycloak.KeycloakTokenAuthenticator;
import org.commonjava.indy.ui.trace.TraceConfiguration;
    ...
    public void init()
    {
        ...
        try
        {
            final Indy.Builder builder = Indy.builder()
                                             ...
                                             .setExistedTraceConfig( traceConfig )
