 ...
 */
package org.commonjava.indy.ui.keycloak;
...
import org.commonjava.indy.ui.http.HttpException;
import org.commonjava.indy.ui.http.HttpProvider;
import org.commonjava.indy.ui.http.UserPass;
        ...
        implements AuthenticationMechanism
{
    ...
    public BasicAuthenticationOAuthTranslator( final KeycloakConfig config, final HttpProvider http )
    {
        this.config = config;
        this.http = http;
        init();
    ...
    public void init()
    {
        ...
        {
            logger.warn(
                    "BASIC authentication is disabled; server.resource and/or server.credential.secret are missing from keycloak.conf!" );
        }
        else
        {
            enabled = true;
