...
import org.commonjava.indy.ui.util.PathUtils;
        ...
        implements IndyUIConfigInfo
{
    ...
    {
        String confDir = System.getProperty( Constants.CONFIG_DIR_PROP );
        if ( confDir == null )
        {
            confDir = PathUtils.normalize( System.getProperty( Constants.INDY_UI_HOME_PROP ), "etc/indy" );
        }
    ...
    {
        return new File( Constants.CONF_INCLUDES_DIR, "keycloak.conf" ).getPath();
    }
